...
# курсивна "1" у шрифті гри стабільно читається tesseract як "7" (гонок 7 немає,
# тож мапимо назад); решта цифр 2-5 читаються коректно.
_RU_HEADER_NUM_RE = re.compile(r"ОНКА\D{0,3}([1-7])")
_RU_DIGIT_FIX = {"6": "", "7": "1"}
