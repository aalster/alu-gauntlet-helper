...
TRANSLATIONS = {
    "en": {
        ...
        "common.shown_count": "Showing {shown} of {total}",
        "field.track": "Track",
        "field.car": "Car",
        "field.rank": "Rank",
        "field.time": "Time",
        ...
        "dialog.delete_confirm_title": "Confirm deletion",
        "dialog.delete_race_confirm": "Delete this race? This action cannot be undone.",
        # settings
    ...
    "uk": {
        ...
        "common.shown_count": "Показано {shown} з {total}",
        "field.track": "Трек",
        "field.car": "Авто",
        "field.rank": "Ранг",
        "field.time": "Час",
        ...
        "dialog.delete_confirm_title": "Підтвердження видалення",
        "dialog.delete_race_confirm": "Видалити цей заїзд? Цю дію не можна скасувати.",
